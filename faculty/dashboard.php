...
// Marks entered (pending publish)
$marksEntered = 0;
if ($facultyId > 0) {
  $stmt = $conn->prepare("
    SELECT COUNT(*) as cnt FROM marks 
    WHERE entered_by_faculty_id = ? AND marks IS NOT NULL
  ");
  $stmt->bind_param('i', $facultyId);
  $stmt->execute();
          ...
          <div class="col-md-6 col-xl-4">
            <div class="card border-0 rounded-4 card-hover h-100">
              <div class="card-body p-4">
                ...
                <div class="small-muted">Pending publish</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row g-3">
          <div class="col-lg-7">
            <div class="glass rounded-4 p-4 border h-100">
              ...
              <div class="small-muted">Hook this to timetable table for the faculty.</div>
              <ul class="mt-3 small-muted mb-0 ps-3">
                <li>10:00 - 11:30 | DBMS | Room 204</li>
                <li>11:45 - 13:15 | DSA | Room 101</li>
              </ul>
            </div>
          </div>
          <div class="col-lg-5">
            <div class="glass rounded-4 p-4 border h-100">
              ...
              <div class="d-grid gap-2">
                <a class="btn btn-outline-dark rounded-3" href="attendance.php"><i class="bi bi-calendar-check me-2"></i>Mark Attendance</a>
                <a class="btn btn-outline-dark rounded-3" href="marks.php"><i class="bi bi-award me-2"></i>Enter Marks</a>
